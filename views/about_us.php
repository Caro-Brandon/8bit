...
<div class="container text-center" data-aos="fade-up" data-aos-delay="100">
  <h2>Somos 8bit</h2>
  <p>Un equipo de estudiantes de la Escuela Tecnica n°26  de 4to año</p>
...
<div class="container" data-aos="fade-up" data-aos-delay="100">
  ...
  <div class="row gy-5">
    ...
    <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="400">
      <div class="team-member">
        <div class="member-img">
          <img src="assets-bootrap/assets/img/team/team-2.jpg" class="img-fluid" alt="">
        </div>
    ...
    <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
      <div class="team-member">
        <div class="member-img">
          <img src="assets-bootrap/assets/img/team/team-1.jpg" class="img-fluid" alt="">
        </div>
        <div class="member-info">
          <div class="social">
            <a href=""><i class="bi bi-twitter-x"></i></a>
    ...
    <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="600">
      <div class="team-member">
        <div class="member-img">
          <img src="assets-bootrap/assets/img/team/team-3.jpg" class="img-fluid" alt="">
        </div>
        <div class="member-info">
          <div class="social">
            <a href=""><i class="bi bi-twitter-x"></i></a>
